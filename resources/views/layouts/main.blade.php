...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ route('kategorimenu') }}" style="color:rgb(255, 255, 255);"
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2021 <a href="https://www.instagram.com/garasi.81/?hl=id">Garage Coffe 81</a>.</strong>
      All rights reserved.
    </footer>
