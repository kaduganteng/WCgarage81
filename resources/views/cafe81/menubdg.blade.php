...
<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner" style="background-image: url(images/menugarasi.jpg);" data-stellar-background-ratio="0.5">
                                    ...
                                    <div class="col-md-3 col-sm-5 col-xs-5 col-xxs-12 fh5co-item-wrap">  
                                        <div class="fh5co-item animate-box">
                                            ...
                                            <a href="{{ asset('upload/' . $m->foto_menu) }}" class="fancybox"
                                                ...
                                                <img src="{{ asset('upload/' . $m->foto_menu) }}" class="img-fluid mb-lg-2"
                                                    alt="white sample" width="180px" height="150px">
                                                </a>
                                                <h3>{{ $m->nama }}</h3>
