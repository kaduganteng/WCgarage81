...
@section('content')
                        ...
                        <div class="row">
                            ...
                            @foreach ($gkopi as $g)
                                <div class="item col-sm-2">
                                    ...
                                    <a href="{{ asset('upload/' . $g->foto_kopip) }}" class="fancybox"
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($kopiportal as $kp)
                                                <tr>
                                                    <td>{{ $no++ }}</td>
                                                    <td>
                                                        <a href="{{ asset('upload/' . $kp->foto_menu) }}"
    ...
    {{-- Modal Edit Kopi --}}
    @foreach ($kopiportal as $kp)
        <div class="modal fade" id="exampleModaledit{{ $kp->id }}" tabindex="-1"
                        ...
                        <form action="{{ url('/editkopi' . $kp->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputName">Nama Menu</label>
                                    <input type="text" class="form-control" name="nama" id="nama"
                                        value="{{ @$kp->nama }}" placeholder="Masukan nama menu">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputName">Harga Menu</label>
                                    <input type="text" class="form-control" name="harga" id="harga"
                                        value="{{ @$kp->harga }}" placeholder="Masukan Harga">
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                    <label class="form-check-label" for="exampleCheck1">Check me out</label>
