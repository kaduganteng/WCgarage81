                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-1">
                                            <div class="text-x font-weight-bold text-success text-uppercase mb-1">
                                                Caffe Bandung</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $s->jml }} Menu
                                            </div>
                                            <a href="{{ route('menubdg') }}"><button type="button"
                                                    class="btn btn-success mt-3 btn-sm shadow-sm"><i
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-1">
                                            <div class="text-x font-weight-bold text-info text-uppercase mb-1">
                                                Caffe Cimahi</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $c->jml }} Menu
                                            </div>
                                            <a href="{{ route('menucmh') }}"><button type="button"
                                                    class="btn btn-info mt-3 btn-sm shadow-sm"><i
                                                        class="fas fa-info-circle"></i>
                                                    Detail</button></a>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-1">
                                            <div class="text-x font-weight-bold text-primary text-uppercase mb-1">
                                                Kopi Portal</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $k->jml }} Menu
                                            </div>
                                            <a href="{{ route('kopiportal') }}"><button type="button"
                                                    class="btn btn-primary mt-3 btn-sm shadow-sm"><i
                                                        class="fas fa-info-circle"></i>
                                                    Detail</button></a>
                                        </div>
                                        <div class="col-auto">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-md-5">
                <div class="card shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <p>Data yang tampil di dashboard merupakan data jumlah menu yang tersedia di dalam web, bukan data
                            stok barang
