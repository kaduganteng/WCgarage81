                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="item col-sm-2">
                            ...
                            <a href="{{ asset('upload/' . $l->foto_list) }}" class="fancybox" data-fancybox="ggblg" data-gallery="gallery" height="50px" width="50px">
                                <img src="{{ asset('upload/' . $l->foto_list) }}" class="img-fluid mb-2" alt="white sample" width="200px" height="200px" />
                            </a>
                            <a href="{{ route('listcmh.destroy', $l->id) }}">
    ...
    <div class="modal fade" id="exampleModallist" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                 <form action="{{ route('listcmh.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
