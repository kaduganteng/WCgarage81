                ...
                <div class="row">
                    <div class="col-md-6 animate-box">
                        <div class="fh5co-heading">
                            <h2>House Specialty Menu</h2>
                            <p>For All of Our Product</p>
                    </div>
                    </div>
                    <div class="col-md-6 col-md-push-1 animate-box">
                        <aside id="fh5co-slider-wrwap">
                            <div class="flexslider">
                                <ul class="slides">
                                    <li style="background-image: url(images/22.jpg);">
                                                ...
                                                <div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
                                                    <div class="slider-text-inner">
                                                        <div class="desc">
                                                            ...
                                                            <p><a href="#" class="btn btn-primary btn-outline">Check It</a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li style="background-image: url(images/io.jpg);">
                                        <div class="overlay-gradient"></div>
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
                                    ...
                                    <li style="background-image: url(images/das.jpg);">
                                        <div class="overlay-gradient"></div>
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-md-12 col-md-offset-0 col-md-pull-10 slider-text slider-text-bg">
